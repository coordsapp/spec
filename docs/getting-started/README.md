...
New team member learning path (read in order):

- [01 - What Coords Is](./01-what-is-coords.md)
- [02 - Core Concepts (L1, L2, Handles, Aliases)](./02-core-concepts.md)
- [03 - Repository Map](./03-repository-map.md)
- [04 - Local Development Setup](./04-local-development-setup.md)
- [05 - First Run: CLI](./05-first-run-cli.md)
- [06 - First Run: Resolver API](./06-first-run-resolver-api.md)
- [07 - Alias Claiming and Verification](./07-alias-claiming-and-verification.md)
